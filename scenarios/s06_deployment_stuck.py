...
def deploy() -> tuple:
    ...
    # Criar deployment inicial que funciona
    manifest = """\
apiVersion: apps/v1
kind: Deployment
metadata:
...
"""
    ...
    # Aguardar os pods estarem rodando
    import time
    time.sleep(5)

    # Disparar um rollout (atualizar a imagem para triggerar)
...
def verify() -> tuple:
    # Verificar se o rollout terminou
    ...
    # Verificar se a estratégia foi corrigida
